...
public class Enemy_3 : Enemy // Enemy_3 расширяет класс Enemy
{
    ...
    // И снова метод Start хорошо подходит, так как не используется суперклассом Enemy
    void Start() {
        points = new Vector3[3]; // Инициализировать массив точке 
    ...
    public override void Move() {
        ...
        if (u > 1) {
            // Этот экземпляр Enemy_3 завершил свой жизненый цикл
        ...
        Vector3 p01, p12;
        u = u - 0.2f*Mathf.Sin(u*Mathf.PI*2); // Сглаживание движения
